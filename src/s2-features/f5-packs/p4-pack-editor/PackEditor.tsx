...
const PackEditor: React.FC<PackEditorPropsType> = ({onClose}) => {
          ...
          <div className={s.editor}>
              ...
              <div className={s.editorBody}>
                  <div className={s.packField}>
                      <input className={s.fieldInput} value={packName} placeholder={"Pack name"} type="text" onChange={onChangePackName}/>
                      {/*<label className={s.fieldLabel}>Pack name</label>*/}
                  </div>
              </div>
              <div className={s.editorFooter}>
                  <button className={sph.button} onClick={createPackHandler}>Add</button>
                  <button className={sph.button} onClick={onClose}>Cancel</button>
              </div>
          </div>
      </div>
    );
